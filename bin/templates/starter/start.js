...
Starter for SuperJS Application

 */


//require dependencies
var {{upper-camel-case projectName}} = require('./{{lower-camel-case projectName}}');

//instantiate the application
var {{lower-camel-case projectName}}Api = new {{upper-camel-case projectName}}();

//start the server
{{lower-camel-case projectName}}Api.start();
